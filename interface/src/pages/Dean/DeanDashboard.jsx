  ...
  const STATS = [
    {
      ...
      value: loading
        ? '...'
        : stats.totalEnrolledStudents.toLocaleString(),
      icon: Users,
      iconBg: 'bg-slate-100',
    ...
    },
    {
      ...
      value: loading
        ? '...'
        : `${stats.facultyAttendanceAverage}%`,
      icon: UserCheck,
      iconBg: 'bg-slate-100',
      iconColor: 'text-[#071B38]',
      footer: 'Faculty attendance average',
      footerColor: 'text-emerald-600',
    ...
    },
    {
      ...
      value: loading
        ? '...'
        : stats.pendingFinalApprovals.toLocaleString(),
      icon: ClipboardX,
      iconBg: 'bg-red-50',
      ...
      footerIcon: null,
      highlight: stats.pendingFinalApprovals > 0,
    },
  ];
    ...
    <div className="flex min-h-screen ">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8">
          ...
          {/* Error */}
          {error && (
            <div className="mb-6 rounded-xl border border-red-300/40 bg-red-500/10 backdrop-blur-xl px-4 py-3 text-sm text-red-200">
              {error}
            </div>
          )}
