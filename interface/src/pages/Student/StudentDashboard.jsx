        ...
        <main className="p-8 max-w-7xl w-full mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative bg-white border border-amber-400 rounded-xl p-5 shadow-xs overflow-hidden flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-slate-900 mt-3">73%</div>
            ...
            <div className="relative bg-white border border-slate-200 rounded-xl p-5 shadow-xs overflow-hidden flex flex-col justify-between">
              ...
              <div>
                <div className="flex items-center space-x-1.5 text-[#071B38] font-bold text-xs tracking-wider">
                  <Calendar className="w-4 h-4" />
                  <span>UPCOMING MEETINGS</span>
                </div>
                <div className="text-3xl font-bold text-slate-900 mt-3">2</div>
            ...
            <div className="relative bg-white border border-emerald-400 rounded-xl p-5 shadow-xs overflow-hidden flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-slate-900 mt-3">Cleared</div>
                <p className="text-xs text-slate-600 mt-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-5 shadow-xs">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="bg-slate-50/80 text-slate-500 font-semibold border-y border-slate-200">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs space-y-4">
              ...
              {/* Alert 1 */}
              <div className="bg-blue-50/40 border border-blue-100 rounded-xl p-4 flex space-x-3">
              ...
              {/* Alert 2 */}
              <div className="bg-blue-50/40 border border-blue-100 rounded-xl p-4 flex space-x-3">
                <div className="w-6 h-6 rounded-full bg-[#071B38] flex items-center justify-center text-white shrink-0 mt-0.5">
